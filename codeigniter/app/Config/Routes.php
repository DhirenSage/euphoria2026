...
$routes->group('admin', ['filter' => 'auth:SUPER_ADMIN,PROGRAMME_ADMIN,EVENT_ADMIN,FINANCE,CONTENT_MANAGER,REPORT_VIEWER'], static function ($routes) {
    ...
    $routes->post('gates', 'AdminController::storeGate');
    $routes->post('scanner-assignments', 'AdminController::storeScannerAssignment');
    $routes->post('scanner-assignments/(:num)/delete', 'AdminController::deleteScannerAssignment/$1');
