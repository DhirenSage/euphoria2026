...
class RegistrationModel extends Model
{
    ...
    protected $allowedFields = ['event_id','registration_id','participant_name','father_name','email','mobile','age','college','city','participant_affiliation','registration_type','team_name','total_amount','status','qr_status','pass_access_hash','pass_access_ciphertext'];
