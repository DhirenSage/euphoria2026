<main class="scanner-shell" data-testid="scanner-console">
  ...
  <section class="scanner-stage">
    ...
    <?php if($demoMode): ?><p class="scanner-demo-note" data-testid="scanner-demo-mode">DEMO MODE · next unused configured event day is selected automatically</p><?php endif ?>
